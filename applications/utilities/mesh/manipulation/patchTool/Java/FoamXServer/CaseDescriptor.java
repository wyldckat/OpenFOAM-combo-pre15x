...
public final class CaseDescriptor implements org.omg.CORBA.portable.IDLEntity
{
  ...
  public CaseDescriptor (String _rootDir, String _rawRootDir, String _caseName, String _appClass, int _nProcs, boolean _managed, boolean _locked, boolean _error)
  {
    rootDir = _rootDir;
