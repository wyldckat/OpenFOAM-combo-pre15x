...
/**
* FoamXServer/BoolListHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.1"
* from PatchTool.idl
* 22 June 2005 14:28:29 o'clock BST
*/

abstract public class BoolListHelper
{
  private static String  _id = "IDL:FoamXServer/BoolList:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (FoamXServer.BoolListHelper.id (), "BoolList", __typeCode);
    }
    return __typeCode;
  }
