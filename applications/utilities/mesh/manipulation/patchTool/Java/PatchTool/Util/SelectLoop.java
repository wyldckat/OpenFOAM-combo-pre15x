...
public class SelectLoop implements ElementSelectListener
{
    //--------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------
    /** Creates new form SelectLoop */
    public SelectLoop(PatchTool pp, boolean selectLoop)
    {
        pp_ = pp;

        selectLoop_ = selectLoop;

        oldMsg_ = pp_.setMsg("Select face on inside of loop");
