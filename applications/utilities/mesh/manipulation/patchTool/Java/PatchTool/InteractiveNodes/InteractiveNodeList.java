    ...
    implements TableModelListener
{
    ...
    public void removeElement(InteractiveNode shape)
    {
        ...
        {
            System.out.println("InteractiveNodeList:removeElement :"
                + " trying to remove illegal shape " + shape.getName());
        }
    }
    ...
    public void removeElementAt(int index)
    {
        ...
        //System.out.println("** Decide  whether to actually delete geometry");
        //- Uncomment following and add 
        //      this.setCapability(Shape3D.ALLOW_GEOMETRY_WRITE);
        // to all Shapes if you want shape to be actually deleted (and memory
        // reclaimed) instead of just hidden.
        shape.remove();
    ...
    public InteractiveNode getShapeAt(int index)
    {
        return (InteractiveNode)shapes_.elementAt(index);
    }
    ...
    public void println()
    {
        ...
        while (enum.hasMoreElements())
        {
            ...
            System.out.println
            (
                i + " " + shape.getName() + " " + shape.isShowing()
            );
            i++;
        }
