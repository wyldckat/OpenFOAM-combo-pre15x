...
public class _ICaseBrowserStub extends org.omg.CORBA.portable.ObjectImpl implements FoamXServer.CaseBrowser.ICaseBrowser
{
  ...
  public void newCase (String rootDir, String caseName, String appClass) throws FoamXServer.FoamXError, FoamXServer.FoamXIOError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                newCase (rootDir, caseName, appClass        );
            } finally {
                _releaseReply ($in);
            }
  } // newCase

  public void importCase (String rootDir, String caseName, String appClass) throws FoamXServer.FoamXError, FoamXServer.FoamXIOError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                importCase (rootDir, caseName, appClass        );
            } finally {
                _releaseReply ($in);
            }
  } // importCase
  ...
  public void addCase (String rootDir, String rawRootDir, String caseName, String appClass) throws FoamXServer.FoamXError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                addCase (rootDir, rawRootDir, caseName, appClass        );
            } finally {
                _releaseReply ($in);
            }
  } // addCase
