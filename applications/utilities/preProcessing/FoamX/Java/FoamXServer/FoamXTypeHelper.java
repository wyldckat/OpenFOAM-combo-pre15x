...
abstract public class FoamXTypeHelper
{
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.ORB.init ().create_enum_tc (FoamXServer.FoamXTypeHelper.id (), "FoamXType", new String[] { "Type_Undefined", "Type_Boolean", "Type_Label", "Type_Scalar", "Type_Char", "Type_Word", "Type_String", "Type_RootDir", "Type_RootAndCase", "Type_CaseName", "Type_HostName", "Type_File", "Type_Directory", "Type_Time", "Type_DimensionSet", "Type_VectorSpace", "Type_List", "Type_Dictionary", "Type_Selection", "Type_Compound", "Type_Field"} );
    }
    return __typeCode;
  }
