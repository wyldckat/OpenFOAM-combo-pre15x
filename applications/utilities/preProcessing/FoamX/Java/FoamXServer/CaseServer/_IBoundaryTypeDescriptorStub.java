...
/**
* FoamXServer/CaseServer/_IBoundaryTypeDescriptorStub.java .
...
// ---------------------------------------------------------------------
public class _IBoundaryTypeDescriptorStub extends org.omg.CORBA.portable.ObjectImpl implements FoamXServer.CaseServer.IBoundaryTypeDescriptor
{
  ...
  public String superType ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_superType", true);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
  ...
  public void superType (String newSuperType)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_set_superType", true);
                $out.write_string (newSuperType);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
  ...
  private static String[] __ids = {
    "IDL:FoamXServer/CaseServer/IBoundaryTypeDescriptor:1.0"};
...
} // class _IBoundaryTypeDescriptorStub
