...
public class _ICaseServerStub extends org.omg.CORBA.portable.ObjectImpl implements FoamXServer.CaseServer.ICaseServer
{
  ...
  public FoamXServer.CaseServer.IApplicationClass applicationClass ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_applicationClass", true);
                $in = _invoke ($out);
                FoamXServer.CaseServer.IApplicationClass $result = FoamXServer.CaseServer.IApplicationClassHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public void addPatch (String patchName, String boundaryType) throws FoamXServer.FoamXError, FoamXServer.FoamXIOError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("addPatch", true);
                $out.write_string (patchName);
                $out.write_string (boundaryType);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                addPatch (patchName, boundaryType        );
            } finally {
                _releaseReply ($in);
            }
  } // addPatch
  ...
  public void setPatchBoundaryType (String patchName, String boundaryType) throws FoamXServer.FoamXError, FoamXServer.FoamXIOError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("setPatchBoundaryType", true);
                $out.write_string (patchName);
                $out.write_string (boundaryType);
                $in = _invoke ($out);
                return;
                ...
                setPatchBoundaryType (patchName, boundaryType        );
            } finally {
                _releaseReply ($in);
            }
  } // setPatchBoundaryType

  public void getPatchBoundaryType (String patchName, org.omg.CORBA.StringHolder boundaryType) throws FoamXServer.FoamXError, FoamXServer.FoamXIOError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getPatchBoundaryType", true);
                $out.write_string (patchName);
                $in = _invoke ($out);
                boundaryType.value = $in.read_string ();
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getPatchBoundaryType (patchName, boundaryType        );
            } finally {
                _releaseReply ($in);
            }
  } // getPatchBoundaryType
  ...
  public void copyDefaultDictionary (String dictionaryName) throws FoamXServer.FoamXError, FoamXServer.FoamXIOError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("copyDefaultDictionary", true);
                $out.write_string (dictionaryName);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                ...
                copyDefaultDictionary (dictionaryName        );
            } finally {
                _releaseReply ($in);
            }
  } // copyDefaultDictionary
