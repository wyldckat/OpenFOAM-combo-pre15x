...
/**
* FoamXServer/CaseServer/_IApplicationClassStub.java .
...
// ---------------------------------------------------------------------
public class _IApplicationClassStub extends org.omg.CORBA.portable.ObjectImpl implements FoamXServer.CaseServer.IApplicationClass
{
  ...
  public String[] boundaryTypes ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_boundaryTypes", true);
                $in = _invoke ($out);
                String $result[] = FoamXServer.StringListHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
  ...
  public void getBoundaryType (String boundaryTypeName, FoamXServer.CaseServer.IBoundaryTypeDescriptorHolder boundaryDescriptor) throws FoamXServer.FoamXError, FoamXServer.FoamXIOError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getBoundaryType", true);
                $out.write_string (boundaryTypeName);
                $in = _invoke ($out);
                boundaryDescriptor.value = FoamXServer.CaseServer.IBoundaryTypeDescriptorHelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getBoundaryType (boundaryTypeName, boundaryDescriptor        );
            } finally {
                _releaseReply ($in);
            }
  } // getBoundaryType

  public void findBoundaryType (String boundaryTypeName, FoamXServer.CaseServer.IBoundaryTypeDescriptorHolder boundaryDescriptor) throws FoamXServer.FoamXError, FoamXServer.FoamXIOError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("findBoundaryType", true);
                $out.write_string (boundaryTypeName);
                $in = _invoke ($out);
                boundaryDescriptor.value = FoamXServer.CaseServer.IBoundaryTypeDescriptorHelper.read ($in);
                return;
                ...
                findBoundaryType (boundaryTypeName, boundaryDescriptor        );
            } finally {
                _releaseReply ($in);
            }
  } // findBoundaryType

  public void addBoundaryType (String boundaryTypeName, FoamXServer.CaseServer.IBoundaryTypeDescriptorHolder boundaryDescriptor) throws FoamXServer.FoamXError, FoamXServer.FoamXIOError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("addBoundaryType", true);
                $out.write_string (boundaryTypeName);
                $in = _invoke ($out);
                boundaryDescriptor.value = FoamXServer.CaseServer.IBoundaryTypeDescriptorHelper.read ($in);
                return;
                ...
                addBoundaryType (boundaryTypeName, boundaryDescriptor        );
            } finally {
                _releaseReply ($in);
            }
  } // addBoundaryType

  public void deleteBoundaryType (String boundaryTypeName) throws FoamXServer.FoamXError, FoamXServer.FoamXIOError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("deleteBoundaryType", true);
                $out.write_string (boundaryTypeName);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                ...
                deleteBoundaryType (boundaryTypeName        );
            } finally {
                _releaseReply ($in);
            }
  } // deleteBoundaryType
  ...
  private static String[] __ids = {
    "IDL:FoamXServer/CaseServer/IApplicationClass:1.0"};
