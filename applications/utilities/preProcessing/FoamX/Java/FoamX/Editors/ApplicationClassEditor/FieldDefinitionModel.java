    ...
    extends AbstractTableModel
{
    ...
    FieldDefinitionModel(ApplicationClassModel appClassModel)
    {
        try
        {
    ...
    void validate() throws ApplicationClassExeption
    {
        ...
        {
            throw new ApplicationClassExeption("Fields", "No Fields Defined.");
        }
        ...
        while (enum.hasMoreElements())
        {
            ...
            if (fieldDesc.getFieldName().length()        == 0) throw new ApplicationClassExeption("Fields", "Invalid Field Name.");
            if (fieldDesc.getFieldDescription().length() == 0) throw new ApplicationClassExeption("Fields", "Invalid Field Description.");
            if (fieldDesc.getFoamTypeName().length()    == 0) throw new ApplicationClassExeption("Fields", "Invalid Field FoamXType.");
            if (fieldDesc.getGeometryTypeName().length() == 0) throw new ApplicationClassExeption("Fields", "Invalid Field Geometry FoamXType.");
        }
    }
