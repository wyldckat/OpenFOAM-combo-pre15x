    ...
    extends javax.swing.JPanel
{
    ...
    public BoundaryDefinitionPanel(ApplicationClassModel appClassModel)
    {
        try
        {
            appClassModel_ = appClassModel;
            tableModel_    = appClassModel_.getBoundaryDefinitionModel();
            ...
            String[] patchFieldTypes = appClassModel_.getPatchFieldTypes();
            for (int i = 0; i <patchFieldTypes.length; i++)
            {
                ITypeDescriptor patchFieldType = appClassModel_.getPatchFieldType(patchFieldTypes[i]);
    ...
    private void boundaryModelChanged(TableModelEvent evt)
    {
        ...
        if (currItem != null && currItem.isBoundaryDefinition())
        {
            ...
            IPatchDescriptor patchType = appClassModel_.getPatchType(currItem.getPatchType());
