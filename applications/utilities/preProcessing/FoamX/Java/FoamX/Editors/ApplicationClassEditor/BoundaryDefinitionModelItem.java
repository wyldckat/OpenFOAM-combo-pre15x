    ...
    implements FoamX.Util.FoamXTreeRenderer.FoamXTreeItem
{
    ...
    private IBoundaryTypeDescriptor boundaryTypeDesc_;
    ...
    public BoundaryDefinitionModelItem(IBoundaryTypeDescriptor boundaryType)
    {
        try
        {
            boundaryTypeDesc_  = boundaryType;
            type_              = NODE_TYPE_BOUNDARYDEF;
            name_              = boundaryType.name();
            displayName_       = boundaryType.displayName();
            description_       = boundaryType.description();
            superType_         = boundaryType.superType();
            patchType_         = boundaryType.patchType();
            patchFieldTypeMap_ = new java.util.Hashtable();

            // Get the patch field types.
            StringPair[] patchFieldTypes = boundaryType.patchFieldTypes();
    ...
    //--------------------------------------------------------------------------
    /**
     * Update the cached IBoundaryTypeDescriptor object.
     */
    public void updateBoundaryTypeDescriptor()
    {
        try
        {
            if (boundaryTypeDesc_ != null)
            {
                // Update the IBoundaryTypeDescriptor object.
                boundaryTypeDesc_.name(name_);
                boundaryTypeDesc_.displayName(displayName_);
                boundaryTypeDesc_.description(description_);
                boundaryTypeDesc_.superType(superType_);
                boundaryTypeDesc_.patchType(patchType_);
                ...
                boundaryTypeDesc_.patchFieldTypes(patchFieldTypes);
            }
        }
        catch (Exception ex)
        {
