...
public class BoundaryTypeSelectorDlg
    extends javax.swing.JDialog
{
    ...
    //--------------------------------------------------------------------------
    /** BoundaryTypeSelectorDlg constructor. */
    public BoundaryTypeSelectorDlg(java.awt.Frame parent, PatchEditorModel patchEditorModel)
    {
        ...
        // Set the tree model.
        boundaryTypeTree_.setModel(patchEditorModel_.getTreeModel());

        // Set tree renderer.
        boundaryTypeTree_.setCellRenderer(new FoamXTreeRenderer());

        // Set single selection.
        boundaryTypeTree_.getSelectionModel().setSelectionMode(TreeSelectionModel.SINGLE_TREE_SELECTION);

        // Listen out for tree selection events.
        boundaryTypeTree_.getSelectionModel().addTreeSelectionListener
        (
    ...
    public void OnSelectionChanged(TreeSelectionEvent evt)
    {
        ...
        {
            App.printMessage("BoundaryTypeSelectorDlg::OnSelectionChanged : " + ex.getMessage());
        }
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        boundaryTypeTree_ = new javax.swing.JTree();
        
        getContentPane().setLayout(new java.awt.GridBagLayout());
        java.awt.GridBagConstraints gridBagConstraints1;
        
        setTitle("Select Boundary Type");
        setName("BoundaryTypeSelectorDlg");
        setModal(true);
        ...
        boundaryTypeTree_.setFont(new java.awt.Font("Dialog", 0, 10));
        boundaryTypeTree_.setShowsRootHandles(true);
        boundaryTypeTree_.setVisibleRowCount(10);
        boundaryTypeTree_.setRootVisible(false);
        boundaryTypeTree_.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                OnMouseClicked(evt);
            }
        });
        
        treeScrollPane_.setViewportView(boundaryTypeTree_);
  ...
  private void OnOK (java.awt.event.ActionEvent evt)
    ...
    private javax.swing.JTree boundaryTypeTree_;
