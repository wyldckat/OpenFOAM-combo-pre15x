...
Foam::labelList Foam::parMetisDecomp::decompose(const pointField& points)
{
    ...
    if (Pstream::myProcNo() >= 1 && nSendCells[Pstream::myProcNo()-1] > 0)
    {
        ...
        IPstream fromPrevProc(Pstream::myProcNo()-1);
    ...
    if (nSendCells[Pstream::myProcNo()] > 0)
    {
        ...
        OPstream toNextProc(Pstream::myProcNo()+1);
    ...
    if (nSendCells[Pstream::myProcNo()] > 0)
    {
        IPstream fromNextProc(Pstream::myProcNo()+1);
    ...
    if (Pstream::myProcNo() >= 1 && nSendCells[Pstream::myProcNo()-1] > 0)
    {
        OPstream toPrevProc(Pstream::myProcNo()-1);
