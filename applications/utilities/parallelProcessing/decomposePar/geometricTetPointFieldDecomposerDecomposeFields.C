...
#include "globalProcessorTetPolyPatchFields.H"
...
geometricTetPointFieldDecomposer::decomposeField
(
...
) const
{
    ...
    // Add the globalProcessor patch by hand.  This needs to be present on
    // all processors
    patchFields.hook
    (
