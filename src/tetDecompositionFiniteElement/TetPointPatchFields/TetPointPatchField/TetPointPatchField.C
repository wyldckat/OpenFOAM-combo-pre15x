...
void TetPointPatchField<PatchField, PointPatch, Type>::checkInternalField() const
{
    ...
    if (iFs != nPoints && iFs != nCells)
    {
        FatalErrorIn
        (
            "void TetPointPatchField<PatchField, PointPatch, Type>::"
...
template<template<class> class PatchField, class PointPatch, class Type>
TetPointPatchField<PatchField, PointPatch, Type>::TetPointPatchField
(
    const PointPatch& p,
    const Field<Type>& iF
)
...
template<template<class> class PatchField, class PointPatch, class Type>
const objectRegistry& TetPointPatchField<PatchField, PointPatch, Type>::db() const
{
...
// Write
template<template<class> class PatchField, class PointPatch, class Type>
void TetPointPatchField<PatchField, PointPatch, Type>::write(Ostream& os) const
{
...
template<template<class> class PatchField, class PointPatch, class Type>
tmp<Field<Type> > TetPointPatchField<PatchField, PointPatch, Type>::
...
tmp<Field<Type1> > TetPointPatchField<PatchField, PointPatch, Type>::
patchInternalField
(
...
) const
{
    ...
    if (iF.size() != internalField().size())
    {
        FatalErrorIn
        (
            "tmp<Field<Type1> > TetPointPatchField<PatchField, PointPatch, "
            "Type>::"
...
template<template<class> class PatchField, class PointPatch, class Type>
bool TetPointPatchField<PatchField, PointPatch, Type>::isPointField() const
{
    return
        internalField().size()
...
// Does this patchField correspond to a pointTypeField
template<template<class> class PatchField, class PointPatch, class Type>
void TetPointPatchField<PatchField, PointPatch, Type>::checkPointField() const
{
    if (!isPointField())
    {
        FatalErrorIn
...
template<template<class> class PatchField, class PointPatch, class Type>
template<class Type1>
void TetPointPatchField<PatchField, PointPatch, Type>::addToInternalField
(
    Field<Type1>& iF,
...
template<template<class> class PatchField, class PointPatch, class Type>
template<class Type1>
void TetPointPatchField<PatchField, PointPatch, Type>::setInInternalField
(
    Field<Type1>& iF,
    const Field<Type1>& pF
) const
...
)
{
    ...
    (
            "Ostream& operator<<"
            "(Ostream&, const TetPointPatchField<PatchField, PointPatch, Type>&"
    );
...
#    include "newTetPointPatchField.C"
