...
#include "defaultPointPatchField.H"
...
template<class Type>
defaultPointPatchField<Type>::defaultPointPatchField
(
    const pointPatch& p,
                ...
                )
                {
                    ...
                    if (!fieldToken.isCompound())
                    {
                        ...
                        else
                        {
                            FatalIOErrorIn
                            (
                                "defaultPointPatchField<Type>::"
                                "defaultPointPatchField"
...
defaultPointPatchField<Type>::defaultPointPatchField
(
    const defaultPointPatchField<Type>& ptf,
    const pointPatch& p,
    const DimensionedField<Type, pointMesh>& iF,
...
template<class Type>
void defaultPointPatchField<Type>::autoMap
(
...
template<class Type>
void defaultPointPatchField<Type>::rmap
(
    const pointPatchField<Type>& ptf,
    const labelList& addr
)
{
    const defaultPointPatchField<Type>& dptf =
        refCast<const defaultPointPatchField<Type> >(ptf);
...
template<class Type>
void defaultPointPatchField<Type>::write(Ostream& os) const
{
