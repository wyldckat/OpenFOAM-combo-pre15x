...
template<template<class> class PatchField, class PointPatch, class Type>
BasicSymmetryPointPatchField<PatchField, PointPatch, Type>::
...
BasicSymmetryPointPatchField
(
    const BasicSymmetryPointPatchField<PatchField, PointPatch, Type>&,
    const PointPatch& p,
    const Field<Type>& iF,
...
BasicSymmetryPointPatchField
(
    const BasicSymmetryPointPatchField<PatchField, PointPatch, Type>& ptf,
    const Field<Type>& iF
)
:
