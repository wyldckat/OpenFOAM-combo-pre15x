    ...
    morphMap_(NULL)
{
    ...
    forAll(cells_, cellI)
    {
        ...
        forAll(curFaces, faceI)
        {
            ...
            if (cells_[cellI][faceI] >= 0) continue;
        ...
        for (label neiSearch = 0; neiSearch < nNeighbours; neiSearch++)
        {
            ...
            if (nextNei > -1)
            {
                ...
                cells_[cellI][nextNei] = nFaces;
                cells_[neiCells[nextNei]][faceOfNeiCell[nextNei]] = nFaces;
    ...
    forAll (boundaryFaces, patchI)
    {
        ...
        forAll (patchFaces, faceI)
        {
            ...
            forAll (facesOfCellInside, cellFaceI)
            {
                ...
                {
                    if (cells_[cellInside][cellFaceI] >= 0)
                    {
                        FatalErrorIn
                        (
                            "polyMesh::polyMesh\n"
                    ...
                    cells_[cellInside][cellFaceI] = nFaces;
    ...
    forAll(cells_, cellI)
    {
        labelList& curCellFaces = cells_[cellI];
