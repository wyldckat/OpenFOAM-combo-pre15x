    ...
    pointEdges_(points_.size())
{
    ...
    if (debug & 4)
    {
        Info<< "edgeSurface : Dumping faceEdges to files" << endl;
        ...
        forAll(faceEdges_, faceI)
        {
            ...
            if (fEdges.size() != 3)
            {
                ...
                Info<< "edgeSurface : Dumping faceEdges for face " << faceI
                    << " to " << faceFName << endl;
        ...
        Info<< "edgeSurface : Dumping edges to edges.obj" << endl;
        OFstream eStream("edges.obj");
        writeOBJ(points_, edges_, eStream);

        Info<< "edgeSurface : Dumping intersectionEdges to"
...
)
{
    if (debug & 2)
    {
        Info<< "Old face consisted of edges:" << endl;
    ...
    if (debug & 2)
    {
        ...
        Info<< "New face consists of edges:" << endl;
        forAll(fEdges, i)
        {
            const edge& e = edges_[fEdges[i]];
