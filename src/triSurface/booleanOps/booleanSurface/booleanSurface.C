    ...
    faceMap_()
{
    if (debug)
    {
        Info<< "booleanSurface : Generating intersected surface for surf1"
            << endl;
    }
    ...
    if (debug)
    {
        Info<< "booleanSurface : Generated cutSurf1: " << endl;
        cutSurf1.writeStats(Info);

        Info<< "Writing to file cutSurf1.ftr" << endl;
    ...
    if (debug)
    {
        Info<< "booleanSurface : Generating intersected surface for surf2"
            << endl;
    }
    ...
    if (debug)
    {
        Info<< "booleanSurface : Generated cutSurf2: " << endl;
        cutSurf2.writeStats(Info);

        Info<< "Writing to file cutSurf2.ftr" << endl;
    ...
    if (debug)
    {
        Info<< "cutSurf1 : starting to fill from face:" << cutSurf1FaceI
            << endl;
    }
    ...
    if (debug)
    {
        Info<< "cutSurf2 : starting to fill from face:" << cutSurf2FaceI
            << endl;
    }
    if (cutSurf2FaceI == -1)
    {
    ...
    faceMap_()
{
    if (debug)
    {
        Info<< "booleanSurface : Testing surf1 and surf2" << endl;
    ...
    if (debug)
    {
        Info<< "booleanSurface : generated points:" << nl
    ...
    if (debug)
    {
        Info<< "booleanSurface : Generated combinedSurf: " << endl;
        combinedSurf.writeStats(Info);

        Info<< "Writing to file combinedSurf.ftr" << endl;
    ...
    if (debug)
    {
        Info<< "booleanSurface : found for point:" << outsidePoint
