    ...
    surf2EdgeCuts_(0)
{
    ...
    if (debug)
    {
        Info<< "surfaceIntersection : Intersection generated:"
            << endl
            << "    points:" << cutPoints_.size() << endl
            << "    edges :" << cutEdges_.size() << endl;

        Info<< "surfaceIntersection : Writing intersection to intEdges.obj"
            << endl;
        ...
        Info<< "Dumping cut edges of surface1 to surf1EdgeCuts.obj" << endl;
        OFstream edge1Stream("surf1EdgeCuts.obj");
        writeIntersectedEdges(surf1, surf1EdgeCuts_, edge1Stream);

        Info<< "Dumping cut edges of surface2 to surf2EdgeCuts.obj" << endl;
    ...
    surf2EdgeCuts_(0)
{
    ...
    // All intersection info (so for both surfaces)
    ...
    if (debug)
    {
        Info<< "Storing surf1 intersections" << endl;
    }
    ...
    if (debug)
    {
        Info<< "Storing surf2 intersections" << endl;
    }
    ...
    surf2EdgeCuts_(0)
{
    ...
    if (hasMerged)
    {
        ...
        forAll(cutEdges_, edgeI)
        {
            ...
            if (e.mag(cutPoints_) < minEdgeLen*intersection::planarTol())
            {
                if (debug)
                {
                    Info<< "Degenerate cut:" << edgeI << " vertices:" << e
    ...
    if (debug)
    {
        Info<< "surfaceIntersection : Intersection generated and compressed:"
            << endl
            << "    points:" << cutPoints_.size() << endl
            << "    edges :" << cutEdges_.size() << endl;
