...
template<class Type>
tmp<Field<Type> > fixedValueOutflowFaPatchField<Type>::gradientInternalCoeffs() const
{
...
//  evaluation of the gradient of this patchField
template<class Type>
tmp<Field<Type> > fixedValueOutflowFaPatchField<Type>::gradientBoundaryCoeffs() const
{
