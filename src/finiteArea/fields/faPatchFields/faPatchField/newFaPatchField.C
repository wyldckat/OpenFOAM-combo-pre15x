...
)
{
    ...
    if (cstrIter == patchConstructorTablePtr_->end())
    {
        ...
        (
            ...
            "const Field<Type>&)"
        )   << "Unknown patchTypefield type " << patchFieldType << endl << endl
...
// a given faPatchField<Type> mapped onto a new patch
template<class Type>
tmp<faPatchField<Type> > faPatchField<Type>::New
(
...
)
{
    if (debug)
    {
        Info<< "faPatchField<Type>::New(const faPatchField<Type>&,"
               " const faPatch&, const Field<Type>&, "
    ...
    (
        cstrIter
     == patchMapperConstructorTablePtr_->end()
    )
    {
        FatalErrorIn
        (
    ...
    if
    (
        patchTypeCstrIter != patchMapperConstructorTablePtr_->end()
    )
    {
...
)
{
    if (debug)
    {
        Info<< "faPatchField<Type>::New(const faPatch&, const Field<Type>&, "
               "const dictionary&) : "
               "constructing faPatchField<Type>"
            << endl;
    }
    ...
    if (cstrIter == dictionaryConstructorTablePtr_->end())
    {
        FatalIOErrorIn
        (
            "faPatchField<Type>::New(const faPatch&, const Field<Type>&, "
            "const dictionary&)",
            dict
    ...
    )
    {
        FatalIOErrorIn
        (
            "faPatchField<Type>const faPatch&, const Field<Type>&, "
            "const dictionary&)",
            dict
