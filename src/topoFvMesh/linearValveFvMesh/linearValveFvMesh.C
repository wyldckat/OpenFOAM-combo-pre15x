...
namespace Foam
{
    ...
    addToRunTimeSelectionTable(topoFvMesh, linearValveFvMesh, IOobject);
}
...
{
    const polyMeshMorphEngine& morphs = morphEngine();
...
void Foam::linearValveFvMesh::moveAndMorph()
{
