...
namespace Foam
{
    defineTypeNameAndDebug(laplaceMotionSolver, 0);
    addToRunTimeSelectionTable(motionSolver, laplaceMotionSolver, dictionary);
}
...
Foam::laplaceMotionSolver::laplaceMotionSolver(const polyMesh& mesh)
:
    motionSolver(mesh),
...
Foam::laplaceMotionSolver::~laplaceMotionSolver()
{
...
void Foam::laplaceMotionSolver::solve()
{
