...
Foam::linearDiff::linearDiff(const tetPolyMesh& tetMesh, const dictionary& dict)
:
    motionDiff(tetMesh),
...
Foam::tmp<Foam::elementScalarField> Foam::linearDiff::gamma() const
{
