...
void Foam::directFaceCollapser::insert
(
...
Foam::label Foam::directFaceCollapser::findEdge
(
...
void Foam::directFaceCollapser::filterFace
(
...
// Construct from mesh
Foam::directFaceCollapser::directFaceCollapser(const polyMesh& mesh)
:
    mesh_(mesh)
{}
...
void Foam::directFaceCollapser::setRefinement
(
...
) const
{
    ...
    forAll(faceLabels, i)
    {
        ...
        if (dist.indices()[dist.size()-1] != fpB)
        {
            ...
            FatalErrorIn("directFaceCollapser::setRefinement")
