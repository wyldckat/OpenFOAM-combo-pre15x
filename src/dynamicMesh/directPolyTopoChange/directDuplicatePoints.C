...
defineTypeNameAndDebug(directDuplicatePoints, 0);
...
// Construct from mesh
Foam::directDuplicatePoints::directDuplicatePoints(const polyMesh& mesh)
:
    mesh_(mesh),
    duplicates_(0)
{}
...
void Foam::directDuplicatePoints::setRefinement
(
...
void Foam::directDuplicatePoints::updateMesh(const mapPolyMesh& map)
{
