...
template<class Type>
void defaultFvPatchField<Type>::autoMap
(
...
template<class Type>
void defaultFvPatchField<Type>::rmap
(
...
)
{
    ...
    const defaultFvPatchField<Type>& dptf =
        refCast<const defaultFvPatchField<Type> >(ptf);
...
template<class Type>
tmp<Field<Type> > defaultFvPatchField<Type>::valueInternalCoeffs
(
...
) const
{
    FatalErrorIn
    (
        "defaultFvPatchField<Type>::"
        "valueInternalCoeffs(const tmp<scalarField>&) const"
    )   << "\n    "
           "valueInternalCoeffs cannot be called for a defaultFvPatchField"
...
template<class Type>
tmp<Field<Type> > defaultFvPatchField<Type>::valueBoundaryCoeffs
(
    const tmp<scalarField>&
) const
{
    ...
    (
        ...
        "valueBoundaryCoeffs(const tmp<scalarField>&) const"
           ...
           "valueBoundaryCoeffs cannot be called for a defaultFvPatchField"
           " (actual type " << actualTypeName_ << ")"
        << "\n    on patch " << this->patch().name()
        << " of field " << this->dimensionedInternalField().name()
        << " in file " << this->dimensionedInternalField().objectPath()
...
template<class Type>
tmp<Field<Type> > defaultFvPatchField<Type>::gradientInternalCoeffs() const
{
    FatalErrorIn
    (
        "defaultFvPatchField<Type>::"
        "gradientInternalCoeffs() const"
           ...
           "gradientInternalCoeffs cannot be called for a defaultFvPatchField"
           " (actual type " << actualTypeName_ << ")"
        << "\n    on patch " << this->patch().name()
        << " of field " << this->dimensionedInternalField().name()
        << " in file " << this->dimensionedInternalField().objectPath()
...
template<class Type>
tmp<Field<Type> > defaultFvPatchField<Type>::gradientBoundaryCoeffs() const
{
    FatalErrorIn
    (
        "defaultFvPatchField<Type>::"
        "gradientBoundaryCoeffs() const"
           ...
           "gradientBoundaryCoeffs cannot be called for a defaultFvPatchField"
           " (actual type " << actualTypeName_ << ")"
        << "\n    on patch " << this->patch().name()
        << " of field " << this->dimensionedInternalField().name()
        << " in file " << this->dimensionedInternalField().objectPath()
